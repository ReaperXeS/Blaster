...
{
	const auto Result = Super::HandleBlockingHit(Hit, TimeTick, MoveDelta, SubTickTimeRemaining);
...
{
	// Rockets should not stop only explode when CollisionBox detects an hit
}
